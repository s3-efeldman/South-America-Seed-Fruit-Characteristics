...
# Traits Included
Native/Introduced: In relation to South America  
...
Portuguese: [https://tinyurl.com/y72nd6xb](https://tinyurl.com/y72nd6xb)
...
Mammal seed dispersal is often characterized into two broad syndromes, fleshy fruit with small seeds that are swallowed and dry fruit with large seeds that are scatter hoarded. However, this broad categorization may overlook patterns in dispersal that could have consequences on plant communities with extinction. In this study, we conducted a systematic review of articles, books, and theses to characterize the plant species dispersed by the mammals of the Colombian and Venezuelan Llanos. We simulated the effects of two extinction scenarios – the loss of threatened mammals and of all large-bodied (> 15 kg) mammals – on native species, fruit type, number of seeds per fruit, seed size, and fruit size. Using a permutation test, we compared changes in the number of links or average trait between pre- and post-extinction to what they would be under random dispersal. Threatened mammal extinction had a marginally negative impact on dehiscent fruit and dry fruit. The extinction of large-bodied mammals had a disproportionately negative impact on the dispersal of introduced species and dry fruit and led to a marginal decrease in the mean width of seeds dispersed. Further empirical study is needed to understand the effects of frugivorous mammals on plant traits beyond seed size, such as fruit type. Additionally, there should be further empirical study on the contribution of mammals to the dispersal of fruits not considered part of their dispersal syndrome.

# Citation
Norford, A. B., Curtis, L., Morais-Perez, A., Moylan, J., Yang, W., Sanghvi, R., Zhu, E., Feldman, E., John, S., Tobar, M. I. S., Laffey, W., Weng, M., Lin, L., Blom, A., & Akçakaya, H. R. (2025). Reconsidering seed dispersal syndromes: a systematic review of mammalian seed dispersal with regard to plant traits in the Colombian and Venezuelan Llanos. Under Review.
